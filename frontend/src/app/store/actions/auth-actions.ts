...
// login
export const loginAction = createAction('[Auth Page] Login', props<{ payload: LoginRequest }>());
...
// register
export const registerAction = createAction('[Auth Page] Register', props<{ payload: RegisterRequest }>())
...
// update profile
export const updateProfileAction = createAction('[Auth Page] profile update', props<{ payload: updateProfileRequest }>())
